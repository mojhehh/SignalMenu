            ...
            try
            {
                if (GorillaNetworking.GorillaComputer.instance?.screenText != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(text))
                    {
                        ...
                        bool isRealBan = (upper.Contains("YOUR ACCOUNT") && upper.Contains("BANNED")) ||
                                         (upper.Contains("YOU ARE") && upper.Contains("BANNED")) ||
                                         (upper.Contains("YOU HAVE BEEN") && upper.Contains("BANNED")) ||
                                         upper.Contains("BAN EXPIRES") ||
                                         upper.Contains("SUSPENSION EXPIRES");
                        if (isRealBan)
                        {
